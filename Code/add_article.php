            ...
            <div class="card-body">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="title" id="title" rows="3" minlength="1" maxlength="60" placeholder="Nadpis"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="abstract">Abstrakt</label>
                        <textarea class="form-control" name="abstract" id="abstract" rows="5" minlength="1" maxlength="150" placeholder="Abstrakt"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="articleText">Text článku</label>
                        <textarea class="form-control" name="articleText" id="articleText" rows="10" minlength="1" maxlength="5000" placeholder="Text článku"></textarea>
                    </div>
                    <div class="form-group">
